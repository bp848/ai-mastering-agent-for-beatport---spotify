...
const SHOT_CARDS: PlanCard[] = [
  {
    ...
    tokenCount: 1,
    features: [
      'フルレンジ・スペクトラル・アナリシス (Full-Range Scan)',
      '高エネルギー・セクション検知 (Drop Identification)',
      '24bit / 96kHz High-Res WAV',
      '詳細エンジニアリング・レポート (PDF) 特典',
      '全額返金保証 (Satisfaction Guarantee)',
    ],
    featuresEn: [
      'Full-Range Spectral Analysis (100% Sample Scan)',
      'High-Energy Section (Drop) Identification',
      '24bit / 96kHz High-Res WAV Support',
      'Detailed Engineering Report included',
