...
const entries = [
  { date: '2026-02-13', items: ['努力目標を LUFS -9 / TP -1 に統一', 'WAVダウンロード安定化（遅延 revoke で起動失敗を防止）', 'Neuro-Drive 迫力回復と高音量ノイズガード強化'] },
  { date: '2026-02', items: ['ダウンロードボタン無反応の修正', '残ダウンロード回数の表示', 'オフラインオーバーサンプリング x32 導入'] },
];
