...
const steps = [
  { icon: Upload, step: '01', title: 'アップロード', desc: 'WAV/MP3/AIFFをドラッグ&ドロップ。登録不要。' },
  { icon: BarChart3, step: '02', title: 'AI解析', desc: '7項目の品質診断。配信基準との差分を自動検出。' },
  { icon: Headphones, step: '03', title: '視聴・比較', desc: 'Before/Afterをワンクリック切替で聴き比べ。' },
  { icon: Download, step: '04', title: 'ダウンロード', desc: '納得したら購入。配信可能なWAVを即座に取得。' },
];
    ...
    <section id="how-it-works" className="scroll-mt-24 border-t border-border/50 py-16 md:py-20">
      <div className="mx-auto max-w-5xl px-4">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-2 text-2xl font-bold text-foreground md:text-3xl">4ステップで完了</h2>
        </div>
