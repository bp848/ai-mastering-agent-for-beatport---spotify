...
const ja = {
  ...
  "paywall.description": "1曲 1,000円（税込）でマスタリングデータを購入すると、WAVをダウンロードできます。料金ページでお支払いください。",
  "paywall.cta": "1曲1,000円で購入する",
  ...
  "result.purchase_cta": "1曲1,000円で購入してWAVを取得",
  "result.purchase_cta_aria": "マスタリングデータを1曲1,000円で購入してWAVをダウンロード（ログインが必要な場合あり）",
...
const en = {
  ...
  "paywall.description": "Purchase mastering data for ¥1,000 per track (tax included) to download WAV. Complete payment on the pricing page.",
  "paywall.cta": "Purchase (¥1,000/track)",
  ...
  "result.purchase_cta": "Purchase & get WAV (¥1,000/track)",
  "result.purchase_cta_aria": "Purchase mastering data for ¥1,000 per track and download WAV (sign-in required if not logged in)",
